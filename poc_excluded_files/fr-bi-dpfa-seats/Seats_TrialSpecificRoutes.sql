...
AS (
    ...
    WHERE DepartureDate BETWEEN GETDATE() AND GETDATE() + 365
        ...
        AND CONCAT (
            ...
            'DUBEMA', 'BCNCRL', 'BCNMXP', 'STNTLS', 'BVATSF', 'CIACPH', 'BCNRAK', 'CRLMAD', 'BODSTN', 'CGNDUB', 'EMADUB', 'CRLBCN', 'MXPBCN', 'TLSSTN', 'TSFBVA', 'CPHCIA', 'RAKBCN', 'MADCRL', 'STNBOD', 'DUBCGN', 'CRLNAP', 'FKBSTN', 'BODCRL', 'LISLUX', 'LISTLS', 'SVQVLC', 'ATHBUD', 'ATHFRA', 'CIYMXP', 'BGYHAM', 'NAPCRL', 'STNFKB', 'CRLBOD', 'LUXLIS', 'TLSLIS', 'VLCSVQ', 'BUDATH', 'FRAATH', 'MXPCIY', 'HAMBGY', 'BODDUB', 'BHDPMI', 'BGYBOD', 'MANSNN', 'BTSCRL', 'EDIOTP', 'BGYZAZ', 'BCNXRY', 'BODOPO', 'BERTFS', 'DUBBOD', 'PMIBHD', 'BODBGY', 'SNNMAN', 'CRLBTS', 'OTPEDI', 'ZAZBGY', 'XRYBCN', 'OPOBOD', 'TFSBER', 'CAGNAP', 'MADPSA', 'BGYTRF', 'CTAVIE', 'BGYGDN', 'OSLSTN', 'MANWMI', 'SVQTLS', 'OPOTER', 'ALCTFN', 'NAPCAG', 'PSAMAD', 'TRFBGY', 'VIECTA', 'GDNBGY', 'STNOSL', 'WMIMAN', 'TLSSVQ', 'TEROPO', 'TFNALC', 'AGPLPA', 'AMMBUD', 'FCOODS', 'BLQODS', 'DUBPLQ', 'GDNPFO', 'NTESVQ', 'ALCMRS', 'ATHCTA', 'TSFVNO', 'LPAAGP', 'BUDAMM', 'ODSFCO', 'ODSBLQ', 'PLQDUB', 'PFOGDN', 'SVQNTE', 'MRSALC', 'CTAATH', 'VNOTSF', 'NYOSTN', 'RAKTLS', 'BDSMLA', 'FEZNRN', 'KTWOSL', 'CHQVIE', 'MANNOC', 'EINNAP', 'AGPTTU', 
            'GROWRO', 'STNNYO', 'TLSRAK', 'MLABDS', 'NRNFEZ', 'OSLKTW', 'VIECHQ', 'NOCMAN', 'NAPEIN', 'TTUAGP', 'WROGRO', 'EDIFKB', 'BHXRHO', 'JTRSTN', 'OTPPMI', 'PEGVIE', 'BLLCHQ', 'CFUDUB', 'BOJVIE', 'BESSEN', 'CFUNUE', 'FKBEDI', 'RHOBHX', 'STNJTR', 'PMIOTP', 'VIEPEG', 'CHQBLL', 'DUBCFU', 'VIEBOJ', 'SENBES', 'NUECFU', 'BRICHQ', 'SZYWRO', 'AGPMAH', 'AHOPSR', 'FMMZAD', 'BDSRHO', 'FSCTLS', 'BVAVCE', 'DUBPIS', 'HHNVCE', 'CHQBRI', 'WROSZY', 'MAHAGP', 'PSRAHO', 'ZADFMM', 'RHOBDS', 'TLSFSC', 'VCEBVA', 'PISDUB', 'VCEHHN', 'PRGVCE', 'BODVCE', 'KRKVCE', 'MANVCE', 'BERVCE', 'BLQMAD', 'MADSCQ', 'RBASTN', 'BCNFRA', 'DUBHAM', 'VCEPRG', 'VCEBOD', 'VCEKRK', 'VCEMAN', 'VCEBER', 'MADBLQ', 'SCQMAD', 'STNRBA', 'FRABCN', 'HAMDUB', 'MADTFS', 'BCNLTN', 'AHOMXP', 'DUBSEN', 'CAGTRN', 'BNXGOT', 'FMMTLV', 'ATHFMM', 'BCNOPO', 'CRLTSF', 'TFSMAD', 'LTNBCN', 'MXPAHO', 'SENDUB', 'TRNCAG', 'GOTBNX', 'TLVFMM', 'FMMATH', 'OPOBCN', 'TSFCRL'
            )
    )
...
AS (
    ...
    FROM (
        ...
        FROM (
            ...
            -- WHERE (
            --         left(ff.route, 3) IN ('BRI', 'BDS')
            --         OR right(ff.route, 3) IN ('BRI', 'BDS')
            --         )
